...
map.getView().fit([-11501920.315941, 2353854.970174, -11498115.050784, 2357387.826713], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Diagnóstico Complementario Unidad Modelo CUCS 2026 - Dr. Eduardo Gómez</h2>';
        return titleElement;
    })(),
